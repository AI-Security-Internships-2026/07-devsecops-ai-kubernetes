...
SYSTEM_PROMPT = (
    ...
    "- To answer about a saved report or a specific image's triage, use list_reports "
    "and get_report (get_report takes an image name, a file path, or 'latest') and "
    "cite the saved SSVC decision/rationale. Don't guess file paths.\n"
